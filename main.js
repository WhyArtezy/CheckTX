...
`;
    ...
    // Fix 2: kirim ke semua user secara paralel
    await Promise.all(
...
Segera periksa transaksi ini!`;
      ...
      // Fix 2: kirim alert besar ke semua user secara paralel
      await Promise.all(
  ...
  // Fix 3: bersihkan processedTx agar memori tidak membengkak
